...
async function middleware(request) {
    ...
    try {
        const response = await fetch(`${process.env.UNKEY_API_URL || "https://api.unkey.dev"}/v1/keys/verify`, {
            method: "POST",
            headers: {
...
/******/ var __webpack_exports__ = (__webpack_exec__(697));
